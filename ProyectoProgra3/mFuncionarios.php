	...
	<div id="cols" class="box">
		...
		<div id="aside" class="box">
			...
			<div class="padding box">
				...
				<p id="btn-create" class="box"><a href="cFuncionarios.html"><span>Regresar</span></a></p>
		...
		<div id="content" class="box">
			...
			<table class="nostyle">
				<tr>
					...
					<td><input type="text" size="40" name="txtNombre" class="input-text" /></td>
				</tr>
				<tr>
					<td>Apellido 1:</td>
					<td><input type="text" size="40" name="txtApellido1" class="input-text" /></td>
				</tr>
				<tr>
					<td class="va-top">Apellido 2:</td>
					<td><input type="text" size="40" name="txtApellido2" class="input-text" /></td>
				</tr>
				<tr>
					<td class="va-top">Email:</td>
					<td><input type="text" size="40" name="txtEmail" class="input-text" /></td>
				</tr>
				
				<tr>
					<td class="va-top">Tel&eacute;fono 1:</td>
					<td><input type="text" size="40" name="txtTelefono1" class="input-text" /></td>
				</tr>
				<tr>
					<td class="va-top">Tel&eacute;fono 2:</td>
					<td><input type="text" size="40" name="txtTelefono2" class="input-text" /></td>
				</tr>
				<tr>
					<td class="va-top">Login:</td>
					<td><input type="text" size="40" name="txtLogin" class="input-text" /></td>
				</tr>
				<tr>
					<td class="va-top">Contrase&ntilde;a:</td>
					<td><input type="password" size="40" name="txtContrasenna" class="input-text" /></td>
				</tr>
				<tr>
